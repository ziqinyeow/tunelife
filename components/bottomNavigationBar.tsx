    ...
    <div className="fixed z-50 w-full h-16 max-w-lg -translate-x-1/2 bg-white border border-gray-200 rounded-full bottom-4 left-1/2 dark:bg-gray-700 dark:border-gray-600">
      <div className="grid h-full max-w-lg grid-cols-5 mx-auto">
        ...
        >
          <Link href="/">
            <svg
              className="w-5 h-5 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-red-600 dark:group-hover:text-red-500"
              aria-hidden="true"
        ...
        >
          <Link href="/leaderboard">
            <svg
              ...
              className="lucide lucide-swords w-5 h-5 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-red-500 dark:group-hover:text-red-500"
            >
        ...
        >
          <Link href="/leaderboard">
            <svg
              ...
              strokeLinecap="round"
              strokeLinejoin="round"
              className="lucide lucide-bar-chart-2 w-5 h-5 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-red-600 dark:group-hover:text-red-500"
            >
        ...
        >
          <Link href="/leaderboard">
            <svg
              ...
              strokeLinecap="round"
              strokeLinejoin="round"
              className="lucide lucide-gift w-5 h-5 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-red-600 dark:group-hover:text-red-500"
            >
